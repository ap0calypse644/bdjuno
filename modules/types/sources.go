...
import (
	...
	saageapp "github.com/saage-tech/saage/app"
...
func buildLocalSources(cfg *local.Details, encodingConfig *params.EncodingConfig) (*Sources, error) {
	...
	saageApp := saageapp.NewSaageApp(
		log.NewTMLogger(log.NewSyncWriter(os.Stdout)), source.StoreDB, nil, true, map[int64]bool{},
		cfg.Home, 0, saageapp.MakeEncodingConfig(), simapp.EmptyAppOptions{},
	)
	...
	sources := &Sources{
		...
		MintSource:     localmintsource.NewSource(source, minttypes.QueryServer(saageApp.MintKeeper)),
